package com.nh.support.client.rest;

import com.nh.support.model.Authentication;
import com.nh.support.utils.DateUtils;
 ...
 * @Description TODO 调用http接口封装工具类
 * @Date 2020/4/2 5:48 PM
 * @Created by nihui
 */
@Slf4j
